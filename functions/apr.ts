export const SECONDS_PER_YEAR =
  365.2425 * 86400 /** SECONDS_PER_YEAR = 31,556,952 */

export const BLOCKS_IN_A_YEAR =
  SECONDS_PER_YEAR / 5 /* Celo block length = 5s */

export const apy2Apr = (apy: number, frequency = BLOCKS_IN_A_YEAR) =>
  ((1 + apy / 100) ** (1 / frequency) - 1) * frequency * 100

export const apr2Apy = (apr: number, frequency = BLOCKS_IN_A_YEAR) =>
