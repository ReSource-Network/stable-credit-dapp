...
interface StableCreditSavingsInterface extends ethers.utils.Interface {
  functions: {
...
export class StableCreditSavings extends BaseContract {
  ...
  interface: StableCreditSavingsInterface;
