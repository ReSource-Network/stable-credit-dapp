...
interface FeeManagerSavingsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "reserveFeePercent()": FunctionFragment;
    "reservePool()": FunctionFragment;
    "savingsFeePercent()": FunctionFragment;
    "savingsPool()": FunctionFragment;
    "stableCredit()": FunctionFragment;
    "totalFeePercent()": FunctionFragment;
    "transferOwnership(address)": FunctionFragment;
    "unpauseFees()": FunctionFragment;
    "updateSavingFeePercents(uint256)": FunctionFragment;
    "updateTotalFeePercents(uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "totalFeePercent",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateSavingFeePercents",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class FeeManagerSavings extends BaseContract {
  ...
  interface: FeeManagerSavingsInterface;
  ...
  functions: {
    ...
    reserveFeePercent(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    totalFeePercent(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    reserveFeePercent(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    totalFeePercent(overrides?: CallOverrides): Promise<PopulatedTransaction>;
