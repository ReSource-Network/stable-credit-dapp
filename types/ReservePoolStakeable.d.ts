...
interface ReservePoolStakeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ReservePoolStakeable extends BaseContract {
  ...
  interface: ReservePoolStakeableInterface;
  ...
  functions: {
    __ReservePoolStakeable_init(
      ...
      _swapRouter: string,
      _sourceSinkPercent: BigNumberish,
