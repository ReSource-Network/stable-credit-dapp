...
interface IReservePoolSavingsInterface extends ethers.utils.Interface {
  functions: {
...
export class IReservePoolSavings extends BaseContract {
  ...
  interface: IReservePoolSavingsInterface;
