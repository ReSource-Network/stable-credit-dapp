...
interface StableCreditPublicDebtInterface extends ethers.utils.Interface {
  functions: {
    "__CIP36_init(string,string)": FunctionFragment;
    "_publicDebt()": FunctionFragment;
    ...
    "burnPublicDebt(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "burnPublicDebt",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "getAccess", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "publicDebt", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "renounceOwnership",
    data: BytesLike
  ): Result;
...
export class StableCreditPublicDebt extends BaseContract {
  ...
  interface: StableCreditPublicDebtInterface;
  ...
  functions: {
    ...
    _publicDebt(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    getAccess(overrides?: CallOverrides): Promise<[string]>;
    ...
    publicDebt(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    getAccess(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    _publicDebt(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    getAccess(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    publicDebt(overrides?: CallOverrides): Promise<PopulatedTransaction>;
